...
def pauli_matrix_from_word(word: PauliWord) -> np.ndarray:
    I, X, Y, Z, _, _ = dense_pauli()
    mats = [I, X, Y, Z]
    return kron_n([mats[i] for i in word.indices])
...
def main() -> None:
    ...
    parser.add_argument("--strobe-objective", choices=["sparse", "range"], default="sparse")
